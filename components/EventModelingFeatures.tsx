        ...
        <div className="contentElement">
            <div className={"columns"}>
                    ...
                    <div>
                        ...
                        <div>
                            <p className={"top-margin has-text-centered"}>
                                <a target="_blank"
                                   href={"https://miro.com/app-install/?response_type=code&client_id=3458764585784610810&redirect_uri=%2Fapp-install%2Fconfirm%2F"}
                                   className={"button is-info"}>
                                    <span className={"bigger"}>Jetzt starten</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                <div className={"column notification is-success is-light padding"}>
                    <h3 className={"has-text-centered"}>Company</h3>
                    <div>
                        <ul>
                            <li>✅ Community Features inklusive</li>
                            <li>✅ Feste Release Versionen (stabiler Stand)</li>
                            <li>✅ Live Modell Validierung</li>
                            <li>✅ 14 Tage kostenloser Test</li>
                            <li>✅ Company Branding</li>
                            <li>✅ E-Mail Support</li>
                            <li>✅ 30 Minuten Onboarding Call</li>
                            <li>✅ Unlimitierte User</li>
                            <li>✅ Unlimitierte Boards</li>
                ...
                <div className={"column notification is-info is-light padding"}>
                    ...
                    <div>
                        <ul>
                            <li>✅ Company Features inklusive</li>
                            <li>✅ Code Generierung inklusive</li>
                            <li>✅ Spring Boot & Spring Modulith Stack</li>
                            <li>✅ Export zu Eventcatalog. Beispiel <a target={"_blank"} href={"https://eventcatalog-demo.nebulit.de/"}>hier</a></li>
                            <li>✅ Premium Support</li>
                            <li>✅ 14 Tage kostenloser Test</li>
                            <li>✅ 60 Minuten Onboarding Call</li>
                            <li>✅ Eventsourcing Blue Print</li>
                            <li>✅ Axon Framework Integration</li>
                            <li>✅ Typescript / NextJS Prototyping</li>
