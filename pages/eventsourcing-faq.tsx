                        ...
                        <Card
                            ...
                            <div className={"has-text-centered nolist"}>
                                ...
                                <div className={"notification is-success is-light"}>
                                    <i className="fa-regular fa-lightbulb"></i><span className={"left-margin"}> Die Fragen werden nach und nach hier beantwortet.</span></div>
                                <div className={"top-margin"}/>

                                <div className={"marginal"}>Was ist CQRS und gehört das zwingend mit Eventsourcing?</div>
