    ...
    return (
        <div>
            <SEO
                                           ...
                                           description={"Auf diesen Seiten und allen Unterseiten findest du hoffentlich wertvolle Informationen zu Eventmodeling und Eventsourcing. Vor allem findest du konkrete Anleitungen und Sourcecode wir Systeme mit Eventmodeling geplant und mit Eventsourcing umgesetzt werden können."} keywords={"Eventmodeling, eventbasierte Entwicklung, Softwareentwicklung, Domain-Driven Design, kollaborative Software Modellierung, CQRS, Eventbasierte Architektur, Agile Entwicklung, Event Storming, Eventmodeling, Microservices, Reaktive Systeme"}/>
                ...
                <div className="hero-body">
                    <div className="container">
                        ...
                        <h2 className="bigger">
                            ...
                            Business Prozesse verstehen. Software Schritt für Schritt verständlich dokumentieren und umsetzen.
                        </h2>
                ...
                <div className="container content">
                    <div className="columns">
                                    ...
                                    <div className="media-content">
                                        <div className="content">
                                            <Link className={"nostyle"}
                                                ...
                                                <div>
                                                    <h3><span className={"blue"}>Blog:</span> Software dokumentieren mit
                                                        Eventmodeling</h3>
                                                    <br/>
                                                    Eventmodeling ist ein wichtiges Werkzeug zur Dokumentation und
                                                    Entwicklung komplexer Softwaresysteme, entwickelt von Adam Dymitruk.
                                                    ...
                                                    visuelle Anordnung dieser Elemente und UI-Mockups erleichtert die
                                                    Darstellung von Funktionsblöcken. Diese Methode bietet eine stets
                                                    aktuelle Dokumentation, erleichtert das Onboarding und fördert die
                                        ...
                                        <div className="content">
                                            <Link className={"nostyle"}
                                                ...
                                                <div>
                                                    ...
                                                    entwickelt wird. Auch technisch komplexe Systeme können so klar und
                                                    verständlich dokumentiert werden, um zukünftige Verbesserungen und
                        ...
                        <div className="column content">
                            ...
                            <div>
                                <h3 className="title is-4">Workshops</h3>
                                <Link href={"/eventmodeling-2x4"}>
                                    <div className="box">
                                        <div>
                                            <strong>Eventmodeling Grundlagen</strong>
                                            <br/>
                                            2x4 Stunden Workshop.
                                        </div>
                                    </div>
                                </Link>
