...
export default function Home() {
    return (
        <div>
            ...
            <aside className="menu left-margin">
                <p className="menu-label">Grundlagen</p>
                <ul className="menu-list">
                    <li><a>Wie du Eventsourcing lernst</a></li>
                    <li><a>Was ist Eventsourcing</a></li>
                    <li><a>Eventsourcing Vorteile / Nachteile</a></li>
                </ul>
                <p className="menu-label">Eventsourcing Patterns</p>
                <ul className="menu-list">
                    <li><a>Live Model</a></li>
                    <li><a>Projektion</a></li>
                    <li><a>Upcasting</a></li>
                    <li><a></a></li>
                </ul>

                <p className="menu-label">Eventsourcing Buch</p>
                                              <ul className="menu-list">
                                                  <li><a>Das Event-Sourcing Buch</a></li>
                                              </ul>
                <p className="menu-label">Eventsourcing Frameworks</p>
                                              <ul className="menu-list">
                                                  <li><a>Axon</a></li>
                                                  <li><a>Emmet</a></li>
                                                  <li><a></a></li>
                        ...
                        <Card
                            ...
                            <div id={"links"}>
                                ...
                                <div>
                                    ...
                                    <div className={"has-text-centered"}>
                                        Im Eventmodeling Tutorial nutzen wir das <Link href={"/eventmodeling-tooling"}>Miro
                                        Tooling</Link>.
                            ...
                            <div className={"top-margin has-text-centered"}>
                                ...
                                <Link href={"/schulungen/schulung-software-mit-eventmodeling-cqrs-und-eventsourcing"}>Wir
                                    planen dein System - Eventmodeling
                                    Workshop</Link>
                            </div>
                            <div className={"has-text-centered"}>
                            ...
                            <div className={"has-text-centered top-margin"}>
                                <h3 className={"blue"}>Warum funktioniert diese moderne Art Software zu entwickeln
                                    eigentlich so gut?</h3>
